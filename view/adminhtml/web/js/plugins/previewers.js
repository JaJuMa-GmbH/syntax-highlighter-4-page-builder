            ...
            create: function () {
                new Prism.plugins.Previewer('easing', function (value) {
                    ...
                    this._elt.innerHTML = '<svg viewBox="-20 -20 140 140" width="100" height="100">' +
                        ...
                        '<line x1="0" y1="100" x2="20" y2="50" marker-start="url(#prism-previewer-easing-marker)" marker-end="url(#prism-previewer-easing-marker)"></line>' +
                        '<line x1="100" y1="0" x2="40" y2="30" marker-start="url(#prism-previewer-easing-marker)" marker-end="url(#prism-previewer-easing-marker)"></line>' +
                        '</svg>';
                });
            },
            tokens: {
